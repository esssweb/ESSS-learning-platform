...
export default function WhoAreWe() {
  return (
    <div className="flex flex-col bg-Tertiary px-4 h-40vh sm:px-5 md:px-10 lg:flex-row items-center">
      <div
      ...
      <div className="flex lg:w-3/4 mt-2 pt-4 justify-center items-start lg:pt-1 lg:justify-start lg:px-7">
